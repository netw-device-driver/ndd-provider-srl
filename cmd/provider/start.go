...
var startCmd = &cobra.Command{
	Use:          "start",
	Short:        "start the srl ndd provider",
	Long:         "start the srl ndd provider",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := controllers.Setup(mgr, nddCtlrOptions(concurrency), logging.NewLogrLogger(zlog.WithName("srl")), pollInterval, namespace); err != nil {
